...
1. Συνδέουμε το Coral με το Raspberry Pi, αφού πρώτα το εγκαταστήσουμε. Οδηγίες εγκατάστασης θα βρείτε εδώ:
http://projects.raspberrypi.org/en/projects/image-id-coral/1

2. Οργανώνουμε τις φωτογραφίες σε κατηγορίες στο directory Data του Raspberry Pi.
...
6. Συνδέουμε το Raspberry Pi με το ένα Adafruit Feather M0 LoRa (δασικός σταθμός παρατήρησης).\
Συνδεσμολογία:\
Το GPIO_pin4 (Raspberry Pi) με το pin 11 (Feather)\
